...
Не рассуждай о роутинге — матчь по таблице:

| Сигнал в запросе | Кому делегируешь |
|---|---|
| Новая фича, «хочу сделать», `/kotik-feature` | spec-writer (после сбора требований) |
| Исследование, сравнение технологий, «что выбрать», `/kotik-research` | researcher |
